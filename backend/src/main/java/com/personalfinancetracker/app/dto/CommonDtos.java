...
public class CommonDtos {
    ...
    public record TransactionResponse(UUID id, TransactionType type, BigDecimal amount, LocalDate transactionDate, UUID accountId, UUID destinationAccountId, UUID categoryId, String merchant, String note, List<String> tags, PaymentMethod paymentMethod, OffsetDateTime createdAt) {}
    ...
    public record RecurringResponse(UUID id, String title, TransactionType transactionType, RecurringFrequency frequency, BigDecimal amount, LocalDate nextRunDate, boolean active, boolean autoCreateTransaction, String merchant, String note) {}
}
