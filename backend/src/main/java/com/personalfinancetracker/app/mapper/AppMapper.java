...
public class AppMapper {
    public UserResponse toUser(User user) { return new UserResponse(user.getId(), user.getEmail(), user.getDisplayName(), user.getGoogleSub() != null && !user.getGoogleSub().isBlank()); }
    ...
    public RecurringResponse toRecurring(RecurringTransaction recurring) { return new RecurringResponse(recurring.getId(), recurring.getTitle(), recurring.getTransactionType(), recurring.getFrequency(), recurring.getAmount(), recurring.getStartDate(), recurring.getEndDate(), recurring.getNextRunDate(), recurring.getAccount() == null ? null : recurring.getAccount().getId(), recurring.getAccount() == null ? null : recurring.getAccount().getName(), recurring.getDestinationAccount() == null ? null : recurring.getDestinationAccount().getId(), recurring.getDestinationAccount() == null ? null : recurring.getDestinationAccount().getName(), recurring.getCategory() == null ? null : recurring.getCategory().getId(), recurring.getCategory() == null ? null : recurring.getCategory().getName(), recurring.isActive(), recurring.isAutoCreateTransaction(), recurring.getMerchant(), recurring.getNote()); }
}
